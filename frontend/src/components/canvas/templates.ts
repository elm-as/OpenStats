...
export const TEMPLATES: CanvasTemplate[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'node_2', type: 'typing', position: { x: 260, y: 280 }, data: { label: 'Détection de types' } },
      { id: 'node_2b', type: 'cleaning', position: { x: 470, y: 280 }, data: { label: 'Nettoyage des données', mode: 'auto' } },
      { id: 'node_3', type: 'descriptiveNumeric', position: { x: 700, y: 120 }, data: { label: 'Stats descriptives (num.)' } },
      { id: 'node_4', type: 'descriptiveCategorical', position: { x: 700, y: 440 }, data: { label: 'Stats descriptives (cat.)' } },
      { id: 'node_5', type: 'correlation', position: { x: 950, y: 60 }, data: { label: 'Matrice de corrélation', method: 'pearson' } },
      { id: 'node_6', type: 'vif', position: { x: 950, y: 240 }, data: { label: 'VIF (Multicolinéarité)' } },
      { id: 'node_7', type: 'pca', position: { x: 1200, y: 60 }, data: { label: 'ACP', nComponents: 'auto' } },
      { id: 'node_8', type: 'mca', position: { x: 1200, y: 440 }, data: { label: 'ACM' } },
      { id: 'node_9', type: 'clustering', position: { x: 1450, y: 250 }, data: { label: 'Clustering', method: 'kmeans' } },
      { id: 'node_10', type: 'regression', position: { x: 1700, y: 150 }, data: { label: 'Régression', models: 'auto' } },
      { id: 'node_11', type: 'classification', position: { x: 1700, y: 380 }, data: { label: 'Classification', models: 'auto' } },
    ],
    edges: [
      { id: 'e1-2', source: 'node_1', target: 'node_2', type: 'animatedDataEdge', data: { color: '#10b981', speed: '2s', speedOffset: '1s' } },
      { id: 'e2-2b', source: 'node_2', target: 'node_2b', type: 'animatedDataEdge', data: { color: '#38bdf8', speed: '2s', speedOffset: '1s' } },
      { id: 'e2b-3', source: 'node_2b', target: 'node_3', type: 'animatedDataEdge', data: { color: '#38bdf8', speed: '2s', speedOffset: '1s' } },
      { id: 'e2b-4', source: 'node_2b', target: 'node_4', type: 'animatedDataEdge', data: { color: '#38bdf8', speed: '2s', speedOffset: '1s' } },
