"""
Simulation Monte Carlo, analyse de sensibilité, tornado charts et stress testing.
"""
...
def partial_dependence_data(
    ...
    for feat in features:
        if feat not in feature_names or not pd.api.types.is_numeric_dtype(X[feat]):
            continue
